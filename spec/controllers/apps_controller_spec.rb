...
describe AppsController do
  ...
  let(:valid_attributes) { { "o_site_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved app as @app" do
        ...
        post :create, {:app => { "o_site_id" => "invalid value" }}, valid_session
        assigns(:app).should be_a_new(App)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested app" do
        ...
        App.any_instance.should_receive(:update).with({ "o_site_id" => "1" })
        put :update, {:id => app.to_param, :app => { "o_site_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the app as @app" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        App.any_instance.stub(:save).and_return(false)
        put :update, {:id => app.to_param, :app => { "o_site_id" => "invalid value" }}, valid_session
        assigns(:app).should eq(app)
      end
